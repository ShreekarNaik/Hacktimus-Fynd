...
const SpinWheel = () => {
  ...
  const stopSpin = async () => {
    ...
    setShowModal(true);
    console.log(
      "States updated: spinning=false, submitting=true, showModal=true"
    );
  ...
  return (
    <Layout>
      <div className="text-center p-4">
        <h1 className="font-titan text-4xl text-purple-500 mb-4 drop-shadow-sm">
          SPIN WHEEL
        </h1>
        ...
        {spinning && (
          <div className="font-titan text-2xl text-gray-400 animate-pulse">
            SPINNING...
          </div>
        )}
          ...
          <div className="p-6 text-center w-full">
            {submitting && (
              <div className="flex flex-col items-center animate-pulse py-8">
                ...
                <h3 className="font-titan text-2xl text-gray-400">
                  CHECKING LUCK...
                </h3>
              </div>
            )}
            ...
            {!submitting && result && (
              <div className="animate-bounce-in">
                ...
                <p className="font-bold text-gray-500 text-lg mb-6">
                  {result.item.label}
                </p>
                ...
                {result.reward && (
                  <div className="bg-yellow-100 p-4 rounded-xl mb-6 text-yellow-800 font-bold border-2 border-yellow-300 border-dashed relative overflow-hidden">
                    ...
                    <div className="text-sm mt-1">
                      {result.reward.discountPercentage}% OFF
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() => navigate("/")}
                    className="block w-full text-gray-400 font-bold text-sm underline hover:text-gray-600"
                  >
                    EXIT GAME
                  </button>
                </div>
