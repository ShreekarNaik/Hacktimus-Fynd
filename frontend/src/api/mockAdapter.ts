...
let companiesStore: Brand[] = [...MOCK_COMPANIES];
...
const mockAdapter: AxiosAdapter = async (config) => {
  ...
  // --- AUTH ROUTES ---
    ...
    // Check Uniqueness
    const existingUser = (MOCK_USERS_DB as any[]).find(
    ...
    // Find user by Phone
    const foundUser = (MOCK_USERS_DB as any[]).find(
