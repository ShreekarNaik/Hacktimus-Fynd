                    ...
                    {loading ? (
                        ...
                        <div>
                            {entries.map((entry, idx) => {
                                ...
                                return (
                                <div key={idx} className={`flex items-center p-4 border-b border-gray-100 relative ${
                                    isMe ? 'bg-purple-50' : (idx < 3 ? 'bg-yellow-50/30' : '')
                                     ...
                                     <div className="flex-1 font-bold text-gray-700 truncate px-2">
                                         {entry.userId}
                                         {isMe && <span className="ml-2 text-[10px] bg-purple-200 text-purple-700 px-1 rounded">YOU</span>}
                                     </div>
                         ...
                         {claimReward && (
                             <div className="animate-bounce-in">
                                 ...
                                 <div className="bg-gradient-to-r from-yellow-100 to-orange-100 p-4 rounded-xl mb-6 text-yellow-800 font-bold border-2 border-yellow-300 border-dashed relative overflow-hidden">
                                      ...
                                      <div className="text-xl font-black break-all">{claimReward.couponCode}</div>
